...
metadata:
  ...
  output-format: code
  related-skills: django-patterns, django-security
---
...
- `django-patterns` — core Django models, DRF, and ORM that produce the files this skill persists to S3
- `django-security` — access control and hardening around stored files and upload flows
- `django-tdd` — test-first workflow for the storage code covered in `references/testing-storages.md`
